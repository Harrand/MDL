...
cd src
g++ -c -std=c++17 -Wall -pedantic-errors -O3 -DMDLLBUILD mdl.cpp
...
g++ -std=c++17 -shared -o mdl.dll mdl.o -Wl,-no-undefined,--enable-runtime-pseudo-reloc,--out-implib,libmdl.a
